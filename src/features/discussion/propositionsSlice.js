...
export const propositionsSlice = createSlice({
  ...
  reducers: {
    updateProposition(state, action) {
      ...
      console.log('p', {index: proposition.index, id: proposition.id, autoFocus: proposition.autoFocus, content: proposition.content}, action.payload)
...
// export const propositionsSelector = propositionsAdapter.getSelectors(state => state.propositions)
